...
@Controller
@RequestMapping("/moderator/fridges")
public class ModeratorFridgesController {

    private final FridgeRepository fridges;
    private final AuditService audit;

    public ModeratorFridgesController(FridgeRepository fridges, AuditService audit) {
    ...
    public String create(@AuthenticationPrincipal CustomUserDetails actor,
        ...
        return "redirect:/moderator/fridges";
    }

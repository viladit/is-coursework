...
@Controller
@RequestMapping("/admin/fridges/{fridgeId}/zones")
public class AdminZonesController {
    ...
    public AdminZonesController(ZoneRepository zones, FridgeRepository fridges, AuditService audit) {
        this.zones = zones;
    ...
    public String create(@AuthenticationPrincipal CustomUserDetails actor,
        ...
        return "redirect:/admin/fridges/" + fridgeId + "/zones";
    }
